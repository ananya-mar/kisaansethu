...
const translations = {
  en: {
    ...
    pestDetectionDescription: 'Upload a plant leaf image to identify potential pests or diseases.',
    uploadImage: 'Upload Image',
    analyzingPlant: 'Analyzing plant health...',
  ...
  te: {
    ...
    pestDetectionDescription: 'సంభావ్య పురుగు లేదా వ్యాధులను గుర్తించడానికి మొక్క ఎలాగి చిత్రం అప్లోడ్ చేయండి.',
    uploadImage: 'చిత్రం అప్లోడ్ చేయండి',
    analyzingPlant: 'మొక్క ఆరోగ్యాన్ని విశ్లేషించుతున్నారు...',
    confidence: 'విశ్వసనీయత',
    description: 'వివరణ',
    commonSymptoms: 'సాధారణ లక్షణాలు',
    recommendedTreatments: 'సిఫార్సు చేయబడిన చికిత్సలు',
    organicSolutions: 'సేంద్రియ పరిష్కారాలు',
    chemicalSolutions: 'రసాయన పరిష్కారాలు',
    analyzeAnotherPlant: 'మరొక మొక్కను విశ్లేషించండి',
  ...
  ta: {
    ...
    pestDetectionDescription: 'மூலக்கீட்டுகள் அல்லது நோய்களை கண்டறிய ஆலை இலை படத்தை பதிவேற்றவும்.',
    uploadImage: 'படத்தை பதிவேற்றவும்',
    analyzingPlant: 'மரத்தின் ஆரோக்கியத்தை பகுப்பாய்வு செய்து கொண்டிருக்கிறது...',
    confidence: 'நம்பிக்கை',
    description: 'விவரம்',
    commonSymptoms: 'பொது அறிகுறிகள்',
    recommendedTreatments: 'பரிந்துரைக்கப்பட்ட சிகிச்சைகள்',
    organicSolutions: 'சेंद्रிய தீர்வுகள்',
    chemicalSolutions: 'ரासாயன தீர்வுகள்',
    analyzeAnotherPlant: 'மற்றொரு செடியை பகுப்பாய்வு செய்யவும்',
  ...
  kn: {
    ...
    pestDetectionDescription: 'ಸಂಭಾವ್ಯ ಕೀಟಗಳು ಅಥವಾ ರೋಗಗಳನ್ನು ಗುರುತಿಸಲು ಸಸ್ಯ ಎಲೆ ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.',
    uploadImage: 'ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ',
    analyzingPlant: 'ಸಸ್ಯದ ಆರೋಗ್ಯವನ್ನು ವಿಶ್ಲೇಷಿಸಲಾಗುತ್ತಿದೆ...',
    confidence: 'ಆತ್ಮವಿಶ್ವಾಸ',
    description: 'ವಿವರಣೆ',
    commonSymptoms: 'ಸಾಮಾನ್ಯ ಲಕ್ಷಣಗಳು',
    recommendedTreatments: 'ಶಿಫಾರಸು ಮಾಡಿದ ಚಿಕಿತ್ಸೆ',
    organicSolutions: 'ಸಸ್ಯೋದ್ದೇಶಿ ಪರಿಹಾರಗಳು',
  ...
  mr: {
    ...
    pestDetectionDescription: 'संभाव्य कीटक किंवा रोग ओळखण्यासाठी वनस्पतीच्या पानाची प्रतिमा अपलोड करा.',
    uploadImage: 'प्रतिमा अपलोड करा',
    analyzingPlant: 'वनस्पतीच्या आरोग्याचे विश्लेषण करत आहे...',
    confidence: 'विश्वास',
    description: 'वर्णन',
    commonSymptoms: 'सामान्य लक्षणे',
    recommendedTreatments: 'शिफारस केलेली उपचार',
    organicSolutions: 'सेंद्रिय उपाय',
    chemicalSolutions: 'रासायनिक उपाय',
    analyzeAnotherPlant: 'पुन्हा दुसरी वनस्पती विश्लेषित करा',
    pestDetection: 'किड ओळख',
  ...
  pa: {
    ...
    pestDetectionDescription: 'ਸੰਭਾਵਿਤ ਕੀੜੇ ਜਾਂ ਬਿਮਾਰੀਆਂ ਦੀ ਪਛਾਣ ਲਈ ਪੌਦੇ ਦੀ ਪੱਤੀ ਦੀ ਤਸਵੀਰ ਅੱਪਲੋਡ ਕਰੋ।',
    uploadImage: 'ਤਸਵੀਰ ਅੱਪਲੋਡ ਕਰੋ',
    analyzingPlant: 'ਪੌਦੇ ਦੇ ਸਿਹਤ ਦਾ ਵਿਸ਼ਲੇਸ਼ਣ ਕੀਤਾ ਜਾ ਰਿਹਾ ਹੈ...',
    confidence: 'ਭਰੋਸਾ',
    description: 'ਵੇਰਵਾ',
    commonSymptoms: 'ਆਮ ਲੱਛਣ',
    recommendedTreatments: 'ਸਿਫ਼ਾਰਸ਼ ਕੀਤੀਆਂ ਇਲਾਜਾਂ',
    organicSolutions: 'ਜੈਵਿਕ ਹੱਲ',
    chemicalSolutions: 'ਰਾਸ਼ਾਇਣਿਕ ਹੱਲ',
    analyzeAnotherPlant: 'ਹੋਰ ਇੱਕ ਪੌਦੇ ਦਾ ਵਿਸ਼ਲੇਸ਼ਣ ਕਰੋ',
